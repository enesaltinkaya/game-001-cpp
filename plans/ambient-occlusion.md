...
Note: this is independent of any GI work. If a probe-based GI pass is ever
built, its probe-occlusion stage can replace this pass; until then XeGTAO is
the cheap, content-free answer.
