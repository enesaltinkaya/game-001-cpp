...
void main() {
    ...
    if ((material.featureMask & (1u << MAT_ALPHA_MASK)) != 0u) {
        ...
        if ((material.featureMask & (1u << MAT_HAS_TEXTURE_COLOR)) != 0u) {
            ...
            // Use textureLod with mip 0 to prevent mip-map alpha bleeding:
            // at higher mip levels, transparent and opaque texels get averaged,
            // causing phantom shadows along quad edges.
