...
void main() {
    ...
    // Keep planar reflection shading free of IBL. The mirrored render already
    // contains the reflected skybox, and adding IBL here makes the reflection
    // too bright because the environment gets counted again.
    vec3 ambientDiffuse = dirLight.ambient.rgb * baseColor.rgb;
