/* ibl_common.shader — shared IBL generation utility functions
 *
 * Include AFTER utils.shader (needs PI).
 * Used by the IBL precompute shaders (pass/ibl/). The scene-side IBL
 * sampling helpers live in ibl_scene.shader (needs globalset.shader).
 */
