...
struct IblData {
    ...
    uint brdfLutIndex;
    uint blueNoiseIndex;
    uint tonemapLutIndex;     // 2D atlas encoding a 64^3 AgX tonemap LUT
    ...
    float sunThreshold;
    uint hasSH;
    uint tonemapMode;   // 0=AgX, 1=AgX Punchy, 2=ACES, 3=Filmic, 4=Reinhard, 5=Uncharted2, 6=Uchimura, 7=Unreal
    uint tonemapLutPunchyIndex;  // 2D atlas encoding AgX Punchy tonemap LUT
    uint pad_ibl2;
...
// Fog data shared with the composite pass.
